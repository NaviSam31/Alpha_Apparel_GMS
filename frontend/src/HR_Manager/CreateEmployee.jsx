...
const CreateEmployee = () => {
  ...
  <div className="mb-4"> {/* Add a margin-bottom to create space */}
    <label className="text-xl mr-4 text-gray-500">Birth Certificate</label>
    <input
      type="file"
  ...
  <div className="mb-4"> {/* Add a margin-bottom to create space */}
    <label className="text-xl mr-4 text-gray-500">Educational Certificates</label>
    <input
      type="file"
  ...
  <div className="mb-4"> {/* Add a margin-bottom to create space */}
    <label className="text-xl mr-4 text-gray-500">Medical Report</label>
    <input
      type="file"
  ...
  <div className="mb-4"> {/* Add a margin-bottom to create space */}
    <label className="text-xl mr-4 text-gray-500">Employee Image</label>
    <input
      type="file"
