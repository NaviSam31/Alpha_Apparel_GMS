...
const DeleteDisplayItem = () => {
  ...
  const handleDeleteDitem = () => {
    setLoading(true);
    axios.delete(`http://localhost:5555/items/${id}`)
      .then(() => {
        setLoading(false);
        navigate('/items/home');
      })
      ...
      <div className='button-container'>
        ...
        <div className='main-content p-4'>
          ...
          <div className='flex flex-col items-center border-2 border-sky-400 rounded-xl w-[600px] p-8 mx-auto'>
            <h3 className='text-2xl'>Are you sure you want to delete this size?</h3>
            <button className='p-4 bg-red-600 text-white m-8 w-full' onClick={handleDeleteDitem}>
              Yes, Delete it.
            </button>
          </div>
        </div>
