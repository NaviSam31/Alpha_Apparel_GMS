...
import BackButton from '../../components/ReOrderBackButton.jsx';
...
const DeleteReOrder = () => {
  ...
  const handleDeleteItem = () => {
    ...
    setLoading(true);
    axios.delete(`http://localhost:5555/reOrder/${id}`)
  .then(() => {
    setLoading(false);
    ...
    <div className="flex">
      ...
      <div className="main-content">
        ...
        <div className='main-content p-4'>
          <BackButton />
          <h1 className='text-3xl my-4'>Delete Re-Order Request</h1>
          {loading && <Spinner />}
          <div className='flex flex-col items-center border-2 border-sky-400 rounded-xl w-[600px] p-8 mx-auto'>
            <h3 className='text-2xl'>Are you sure you want to delete this re-order request?</h3>
            <button
