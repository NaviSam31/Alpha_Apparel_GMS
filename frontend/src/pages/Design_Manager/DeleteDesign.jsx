...
const DeleteDesigns = () => {
  ...
  const handleDeleteDesign = () => {
    setLoading(true);
    axios.delete(`http://localhost:5555/designs/${id}`)
      .then(() => {
        setLoading(false);
    ...
    <div className="main-content">
      ...
      <div className='button-container'>
        ...
        <div className='main-content p-4'>
          <BackButton />
          <h1 className='text-3xl my-4'>Delete Design Record</h1>
          {loading ? <Spinner /> : ''}
          <div className='flex flex-col items-center border-2 border-sky-400 rounded-xl w-[600px] p-8 mx-auto'>
            <h3 className='text-2xl'>Are you sure you want to delete this design?</h3>
